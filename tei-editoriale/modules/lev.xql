...
module namespace lev="http://exist-db.org/apps/tei-editoriale/modules";
...
declare function lev:levenshtein-distance(
...
declare function lev:_levenshtein-distance(
...
as xs:integer { 
    ...
    return
        if ($total eq $length1 + $length2) then 
            ...
            lev:_levenshtein-distance($chars1, $chars2, $length1, $length2, $diag, $total + 1) 
};